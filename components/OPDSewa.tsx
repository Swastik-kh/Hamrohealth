              ...
              <div className="space-y-6 animate-in fade-in">
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                  <h4 className="text-sm font-semibold text-slate-700 mb-3 flex items-center gap-2">
                    <Activity size={16} className="text-primary-500" /> भाइटल्स (Vitals)
                  </h4>
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-2 text-sm border border-slate-300 rounded focus:ring-1 focus:ring-primary-500"
                        placeholder="120/80"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      <label className="block text-xs font-medium text-slate-500 mb-1">RR (bpm)</label>
                      <input
                        type="text"
                        value={opdData.rr || ''}
